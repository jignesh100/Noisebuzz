...
class MainActivity : AppCompatActivity() {
    ...
    fun incition()
    {
        ...
        binding.musicRv.setItemViewCacheSize(18)
...
//for requesting
    private fun requestRuntimePermission(){
        ...
        {
            ActivityCompat.requestPermissions(this, arrayOf(android.Manifest.permission.WRITE_EXTERNAL_STORAGE),80)
        ...
        if (requestCode == 80) {
            if (grantResults.isNotEmpty() && grantResults[0] != PackageManager.PERMISSION_GRANTED){
                ...
                ActivityCompat.requestPermissions(
                    this,
                    arrayOf(android.Manifest.permission.WRITE_EXTERNAL_STORAGE), 80)
            }
        }
    }
